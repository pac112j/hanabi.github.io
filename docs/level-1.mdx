...
1. 2 카드 (_2 보존 단서_)
1. 중요 카드 (색상 또는 숫자)
- 또한 저희 그룹의 플레이어는 (유일한) 플레이 가능한 카드를 절대 잃지 않기를 원합니다. 하지만 유일한 플레이 가능한 카드에 대한 단서는 _보존 단서_가 아닌 _플레이 단서_로 정의됩니다.


### 단서 집중


단서의 집중 대상을 결정하는 4단계 과정은 다음과 같습니다.


1. 새로운 카드가 없다면, **집중 대상은 가장 왼쪽에 다시 만져진 카드입니다**.

2. 새로운 카드가 한 장만 있다면, **집중 대상은 새로운 카드입니다**.

3. 새로운 카드가 두 장 이상 있고, 그중 하나가 촙에 있었다면, **집중 대상은 촙입니다**.

4. 새로운 카드가 두 장 이상 있고, 그중 어떤 카드도 촙에 없었다면, **집중 대상은 가장 왼쪽에 있는 새로운 카드입니다**.
